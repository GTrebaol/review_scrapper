...
class SonarqubeDecoration:
    ...
    def write_measure_in_sonarqube_decoration_template(self, measure_name, measure):
        """
        ...
        with fileinput.FileInput(
            ...
            for line in file:
                ...
                self._logger.info(line, end="")

    def process_measure(self, measure_name):
        """
        Get a measure and add it in the template file.
        :param measure: The sonarqube measure to get.
        """
        measure = self.get_measure(measure_name)
        self.write_measure_in_sonarqube_decoration_template(measure_name, measure)

    def process_sonarqube_decoration(self):
        """
        Get all measures and add them in the template file.
        """
        self.write_measure_in_sonarqube_decoration_template(
            "project", self._sonar_project_name
        )
        self.write_measure_in_sonarqube_decoration_template("branch", self._branch)
        self.write_measure_in_sonarqube_decoration_template(
